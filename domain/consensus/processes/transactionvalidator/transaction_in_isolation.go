...
func (v *transactionValidator) checkTransactionAmountRanges(tx *externalapi.DomainTransaction) error {
	...
	// as a seep. One slyvex is a quantity of seep as defined by the
	// sompiPerSlyvex constant.
	...
	for _, txOut := range tx.Outputs {
		...
		// This is impossible for slyvex, but perhaps possible if an alt increases
