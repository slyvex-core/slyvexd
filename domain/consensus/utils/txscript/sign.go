...
// SignatureScript creates an input signature script for tx to spend SVX sent
...
// SignatureScriptECDSA creates an input signature script for tx to spend SVX sent
