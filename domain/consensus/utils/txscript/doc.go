/*
Package txscript implements the slyvex transaction script language.

This package provides data structures and functions to parse and execute
slyvex transaction scripts.

# Script Overview

slyvex transaction scripts are written in a stack-base, FORTH-like language.

The slyvex script language consists of a number of opcodes which fall into
...
Typical slyvex scripts at the time of this writing are of several standard
...
what conditions must be met in order to spend slyvex.
