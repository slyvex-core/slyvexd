...
import (
	...
	"github.com/slyvex-core/slyvexd/util/network"
...
// Params defines a Slyvex network by its parameters. These parameters may be
// used by Slyvex applications to differentiate networks as well as addresses
...
type Params struct {
	...
	// Further details: https://hashdag.medium.com/slyvex-launch-plan-9a63f4d754a6
...
// MainnetParams defines the network parameters for the main Slyvex network.
var MainnetParams = Params{
	...
	Prefix: util.Bech32PrefixSlyvex,
...
// TestnetParams defines the network parameters for the test Slyvex network.
var TestnetParams = Params{
	K:           defaultGHOSTDAGK,
	Name:        "slyvex-testnet-10",
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSlyvexTest,
...
// SimnetParams defines the network parameters for the simulation test Slyvex
...
var SimnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSlyvexSim,
...
// DevnetParams defines the network parameters for the development Slyvex network.
var DevnetParams = Params{
	...
	// Human-readable part for Bech32 encoded addresses
	Prefix: util.Bech32PrefixSlyvexDev,
...
// ErrDuplicateNet describes an error where the parameters for a Slyvex
// network could not be set due to the network already being a standard
// network or previously-registered into this package.
var ErrDuplicateNet = errors.New("duplicate Slyvex network")

var registeredNets = make(map[appmessage.SlyvexNet]struct{})

// Register registers the network parameters for a Slyvex network. This may
