...
import (
	...
	"github.com/slyvex-core/slyvexd/domain/consensus/utils/blockheader"
...
var genesisTxPayload = []byte{
	...
	0x01,                                           // Varint
	0x00,                                           // OP-FALSE
	0x53, 0x6c, 0x79, 0x56, 0x65, 0x58, 0x20, 0x42, // SlyVeX BlockDAG Network
	0x6c, 0x6f, 0x63, 0x6b, 0x44, 0x41, 0x47, 0x20, 
	0x4e, 0x65, 0x74, 0x77, 0x6f, 0x72, 0x6b,
}
...
var genesisHash = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0xb1, 0x69, 0x67, 0xde, 0xe7, 0x21, 0xc2, 0xf4, 
	0x92, 0x63, 0xa7, 0xbe, 0x36, 0x18, 0xde, 0x8e, 
	0xb4, 0x83, 0xd9, 0x45, 0xb8, 0xd2, 0xb0, 0x45, 
	0x48, 0x92, 0x6e, 0x99, 0xdf, 0xf1, 0x01, 0xda,
})

// genesisMerkleRoot is the hash of the first transaction in the genesis block
// for the main network.
var genesisMerkleRoot = externalapi.NewDomainHashFromByteArray(&[externalapi.DomainHashSize]byte{
	0x0f, 0xe0, 0x9a, 0x05, 0x2b, 0x5a, 0xa1, 0x15, 
	0xdc, 0x29, 0x3d, 0x51, 0x23, 0xb2, 0xb3, 0x61, 
	0x00, 0x12, 0x88, 0x2e, 0x55, 0xe9, 0xae, 0x53, 
	0x15, 0x3a, 0x6e, 0x84, 0x72, 0x5d, 0x0a, 0x3a,
})
...
var devnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x64, 0x65, 0x76, 0x6e, 0x65, 0x74, // slyvex-devnet
}
...
var simnetGenesisTxPayload = []byte{
	...
	0x01,                                                                   // Varint
	0x00,                                                                   // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x73, 0x69, 0x6d, 0x6e, 0x65, 0x74, // slyvex-simnet
}
...
var testnetGenesisTxPayload = []byte{
	...
	0x01,                                                                         // Varint
	0x00,                                                                         // OP-FALSE
	0x6b, 0x61, 0x73, 0x70, 0x61, 0x2d, 0x74, 0x65, 0x73, 0x74, 0x6e, 0x65, 0x74, // slyvex-testnet
}
