...
const (
	...
	defaultSubsidyGenesisReward                    = 1 * constants.SompiPerSlyvex
	defaultPreDeflationaryPhaseBaseSubsidy         = 500 * constants.SompiPerSlyvex
	defaultDeflationaryPhaseBaseSubsidy            = 440 * constants.SompiPerSlyvex
	...
	defaultDeflationaryPhaseDaaScore = 15778800
