...
import (
	...
	"github.com/slyvex-core/slyvexd/domain/consensusreference"
	"github.com/slyvex-core/slyvexd/domain/miningmanager/model"
	...
	"github.com/slyvex-core/slyvexd/domain/miningmanager"
...
func generateNewCoinbase(addressPrefix util.Bech32Prefix, op opType) (*externalapi.DomainCoinbaseData, error) {
	...
	_, publicKey, err := libslyvexwallet.CreateKeyPair(op == opECDSA)
	if err != nil {
		return nil, err
	}
	var address string
