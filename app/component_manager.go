...
import (
	...
	"github.com/slyvex-core/slyvexd/app/rpc"
	...
	"github.com/slyvex-core/slyvexd/infrastructure/network/netadapter/id"
	"github.com/slyvex-core/slyvexd/util/panics"
)

// ComponentManager is a wrapper for all the Slyvexd Services
...
// Start launches all the Slyvexd Services.
...
// Stop gracefully shuts down all the Slyvexd Services.
func (a *ComponentManager) Stop() {
	// Make sure this only happens once.
	if atomic.AddInt32(&a.shutdown, 1) != 1 {
		log.Infof("slyvexd is already in the process of shutting down")
		return
	}

	log.Warnf("slyvexd shutting down")
