...
// MsgRequestTransactions implements the Message interface and represents a slyvex
...
// NewMsgRequestTransactions returns a new slyvex RequestTransactions message that conforms to
