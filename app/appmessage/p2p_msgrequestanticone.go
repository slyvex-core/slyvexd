...
// MsgRequestAnticone implements the Message interface and represents a slyvex
...
// NewMsgRequestAnticone returns a new slyvex RequestPastDiff message that conforms to the
