...
// MsgIBDChainBlockLocator implements the Message interface and represents a slyvex
...
// NewMsgIBDChainBlockLocator returns a new slyvex locator message that conforms to
