...
// MsgDoneBlocksWithTrustedData implements the Message interface and represents a slyvex
...
// NewMsgDoneBlocksWithTrustedData returns a new slyvex DoneBlocksWithTrustedData message that conforms to the
// Message interface.
