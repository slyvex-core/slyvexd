...
// slyvex Addresses message (MsgAddresses).
const MaxAddressesPerMsg = 1000

// MsgAddresses implements the Message interface and represents a slyvex
// Addresses message.
...
// NewMsgAddresses returns a new slyvex Addresses message that conforms to the
