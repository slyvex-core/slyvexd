...
var DefaultUserAgent = fmt.Sprintf("/slyvexd:%s/", version.Version())

// MsgVersion implements the Message interface and represents a slyvex version
...
// NewMsgVersion returns a new slyvex version message that conforms to the
