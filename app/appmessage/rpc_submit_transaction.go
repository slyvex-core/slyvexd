...
// RPCTransaction is a slyvexd transaction representation meant to be
// used over RPC
...
// RPCTransactionInput is a slyvexd transaction input representation
...
// RPCScriptPublicKey is a slyvexd ScriptPublicKey representation
type RPCScriptPublicKey struct {
	Version uint16
	Script  string
}

// RPCTransactionOutput is a slyvexd transaction output representation
// meant to be used over RPC
...
// RPCOutpoint is a slyvexd outpoint representation meant to be used
// over RPC
...
// RPCUTXOEntry is a slyvexd utxo entry representation meant to be used
// over RPC
