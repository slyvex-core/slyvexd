...
// MsgRequestAddresses implements the Message interface and represents a slyvex
...
// NewMsgRequestAddresses returns a new slyvex RequestAddresses message that conforms to the
