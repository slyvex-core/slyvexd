...
// MsgRequestRelayBlocks implements the Message interface and represents a slyvex
...
// NewMsgRequestRelayBlocks returns a new slyvex RequestRelayBlocks message that conforms to
