...
// MsgTransactionNotFound defines a slyvex TransactionNotFound message which is sent in response to
...
// NewMsgTransactionNotFound returns a new slyvex transactionsnotfound message that conforms to the
