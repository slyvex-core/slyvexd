...
// MsgRequestNextHeaders implements the Message interface and represents a slyvex
...
// NewMsgRequestNextHeaders returns a new slyvex RequestNextHeaders message that conforms to the
// Message interface.
