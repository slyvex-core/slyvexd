...
// MsgRequestHeaders implements the Message interface and represents a slyvex
...
// NewMsgRequstHeaders returns a new slyvex RequestHeaders message that conforms to the
