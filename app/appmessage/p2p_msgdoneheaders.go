...
// MsgDoneHeaders implements the Message interface and represents a slyvex
...
// NewMsgDoneHeaders returns a new slyvex DoneIBDBlocks message that conforms to the
// Message interface.
