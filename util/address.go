...
import (
	...
	"github.com/slyvex-core/slyvexd/util/bech32"
)
...
const (
	...
	Bech32PrefixSlyvexDev

	// Prefix for the test network.
	Bech32PrefixSlyvexTest

	// Prefix for the simulation network.
	Bech32PrefixSlyvexSim
)
...
var stringsToBech32Prefixes = map[string]Bech32Prefix{
	"slyvex":     Bech32PrefixSlyvex,
	"slyvexdev":  Bech32PrefixSlyvexDev,
	"slyvextest": Bech32PrefixSlyvexTest,
	"slyvexsim":  Bech32PrefixSlyvexSim,
}
...
// and a payload which encodes the slyvex network and address type. It is used
...
// with the passed slyvex network.
