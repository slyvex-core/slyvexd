...
func TestAddresses(t *testing.T) {
	tests := []struct {
		...
		{
			name:    "mainnet p2pk",
			addr:    "slyvex:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			encoded: "slyvex:qr35ennsep3hxfe7lnz5ee7j5jgmkjswsn35ennsep3hxfe7ln35cdv0dy335",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSlyvex,
			...
			f: func() (util.Address, error) {
				publicKey := []byte{
					...
					0xe3, 0x4c, 0xce, 0x70, 0xc8, 0x63, 0x73, 0x27, 0x3e, 0xfc,
					0xe3, 0x4c}
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixSlyvex)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		{
			name:    "mainnet p2pk 2",
			addr:    "slyvex:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			encoded: "slyvex:qq80qvqs0lfxuzmt7sz3909ze6camq9d4t35ennsep3hxfe7ln35cvfqgz3z8",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSlyvex,
				[util.PublicKeySize]byte{
			...
			passedPrefix:   util.Bech32PrefixSlyvex,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		{
			name:    "testnet p2pk",
			addr:    "slyvextest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			encoded: "slyvextest:qputx94qseratdmjs0j395mq8u03er0x3l35ennsep3hxfe7ln35ckquw528z",
			valid:   true,
			result: util.TstAddressPubKey(
				util.Bech32PrefixSlyvexTest,
				[util.PublicKeySize]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKey(publicKey, util.Bech32PrefixSlyvexTest)
			},
			passedPrefix:   util.Bech32PrefixSlyvexTest,
			expectedPrefix: util.Bech32PrefixSlyvexTest,
		},

		// ECDSA P2PK tests.
		{
			name:    "mainnet ecdsa p2pk",
			addr:    "slyvex:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			encoded: "slyvex:qyp0r5mcq4rd5grj3652ra09u5dcgwqq9ntuswp247nama5quyj40eq03sc2dkx",
			valid:   true,
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressPublicKeyECDSA(publicKey, util.Bech32PrefixSlyvex)
			},
			passedPrefix:   util.Bech32PrefixUnknown,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		...
		},
		{
			...
			addr:           "slyvex:qr35ennsep3hxfe7lnz5ee7j5jgmkjswss74as46gx",
			valid:          false,
			passedPrefix:   util.Bech32PrefixSlyvex,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		...
		{
			name:    "mainnet p2sh",
			addr:    "slyvex:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			encoded: "slyvex:prq20q4qd9ulr044cauyy9wtpeupqpjv67pn2vyc6acly7xqkrjdzmh8rj9f4",
			valid:   true,
			...
			f: func() (util.Address, error) {
				script := []byte{
					...
					0xae}
				return util.NewAddressScriptHash(script, util.Bech32PrefixSlyvex)
			},
			passedPrefix:   util.Bech32PrefixSlyvex,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		{
			name:    "mainnet p2sh 2",
			addr:    "slyvex:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			encoded: "slyvex:pr5vxqxg0xrwl2zvxlq9rxffqx00sm44kn5vxqxg0xrwl2zvxl5vxyhvsake2",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixSlyvex,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixSlyvex)
			},
			passedPrefix:   util.Bech32PrefixSlyvex,
			expectedPrefix: util.Bech32PrefixSlyvex,
		},
		{
			name:    "testnet p2sh",
			addr:    "slyvextest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			encoded: "slyvextest:przhjdpv93xfygpqtckdc2zkzuzqeyj2pt5vxqxg0xrwl2zvxl5vx35yyy2h9",
			valid:   true,
			result: util.TstAddressScriptHash(
				util.Bech32PrefixSlyvexTest,
				[blake2b.Size256]byte{
			...
			f: func() (util.Address, error) {
				...
				return util.NewAddressScriptHashFromHash(hash, util.Bech32PrefixSlyvexTest)
			},
			passedPrefix:   util.Bech32PrefixSlyvexTest,
			expectedPrefix: util.Bech32PrefixSlyvexTest,
		},
...
func TestDecodeAddressErrorConditions(t *testing.T) {
	tests := []struct {
		...
		{
			"slyvexsim:raskzctpv9skzctpv9skzctpv9skzctpvy37ct7zafpv9skzctpvymmnd3gh8",
			util.Bech32PrefixSlyvexSim,
			"unknown address type",
		},
		{
			"slyvexsim:raskzcg58mth0an",
			util.Bech32PrefixSlyvexSim,
			"unknown address type",
		},
		{
			"slyvextest:qqq65mvpxcmajeq44n2n8vfn6u9f8l4zsy0xez0tzw",
			util.Bech32PrefixSlyvex,
...
func TestParsePrefix(t *testing.T) {
	tests := []struct {
		...
		{"slyvex", util.Bech32PrefixSlyvex, false},
		{"slyvextest", util.Bech32PrefixSlyvexTest, false},
		{"slyvexsim", util.Bech32PrefixSlyvexSim, false},
...
func TestPrefixToString(t *testing.T) {
	tests := []struct {
		...
		{util.Bech32PrefixSlyvex, "slyvex"},
		{util.Bech32PrefixSlyvexTest, "slyvextest"},
		{util.Bech32PrefixSlyvexSim, "slyvexsim"},
		{util.Bech32PrefixUnknown, ""},
	}
