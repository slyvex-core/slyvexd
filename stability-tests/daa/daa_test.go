...
const miningAddress = "slyvexdev:qrcqat6l9zcjsu7swnaztqzrv0s7hu04skpaezxk43y4etj8ncwfkuhy0zmax"
...
func runDAATest(t *testing.T, testName string, runDuration time.Duration,
	...
	tearDownSlyvexd := common.RunSlyvexdForTesting(t, "slyvexd-daa-test", rpcAddress)
	defer tearDownSlyvexd()
