...
func TestVirtualSelectedParentBlueScoreAndVirtualDAAScore(t *testing.T) {
	...
	response, err := slyvexd.rpcClient.GetVirtualSelectedParentBlueScore()
	if err != nil {
	...
	err = slyvexd.rpcClient.RegisterForVirtualSelectedParentBlueScoreChangedNotifications(
	...
	err = slyvexd.rpcClient.RegisterForVirtualDaaScoreChangedNotifications(
