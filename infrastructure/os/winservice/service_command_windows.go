...
// installService attempts to install the Slyvexd Service. Typically this should
...
// removeService attempts to uninstall the Slyvexd Service. Typically this should
...
// startService attempts to Start the Slyvexd Service.
