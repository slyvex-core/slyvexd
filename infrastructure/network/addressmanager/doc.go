/*
Package addressmanager implements concurrency safe slyvex address manager.

# Address Manager Overview

In order maintain the peer-to-peer slyvex network, there needs to be a source
of addresses to connect to as nodes come and go. The slyvex protocol provides
