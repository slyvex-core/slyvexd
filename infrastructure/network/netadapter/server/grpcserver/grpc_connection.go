...
type grpcStream interface {
	Send(*protowire.SlyvexdMessage) error
	Recv() (*protowire.SlyvexdMessage, error)
}
...
func (c *gRPCConnection) receive() (*protowire.SlyvexdMessage, error) {
...
func (c *gRPCConnection) send(message *protowire.SlyvexdMessage) error {
