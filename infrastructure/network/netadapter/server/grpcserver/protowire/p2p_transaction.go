...
func (x *SlyvexdMessage_Transaction) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SlyvexdMessage_Transaction is nil")
	}
	return x.Transaction.toAppMessage()
}

func (x *SlyvexdMessage_Transaction) fromAppMessage(msgTx *appmessage.MsgTx) error {
