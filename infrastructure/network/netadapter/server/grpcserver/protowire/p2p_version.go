...
import (
	...
	"github.com/slyvex-core/slyvexd/util/mstime"
	"github.com/pkg/errors"
)

func (x *SlyvexdMessage_Version) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrapf(errorNil, "SlyvexdMessage_Version is nil")
	}
...
func (x *SlyvexdMessage_Version) fromAppMessage(msgVersion *appmessage.MsgVersion) error {
