...
type P2P_MessageStreamClient interface {
	Send(*SlyvexdMessage) error
	Recv() (*SlyvexdMessage, error)
	grpc.ClientStream
}
...
func (x *p2PMessageStreamClient) Send(m *SlyvexdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *p2PMessageStreamClient) Recv() (*SlyvexdMessage, error) {
	m := new(SlyvexdMessage)
...
func (x *p2PMessageStreamServer) Send(m *SlyvexdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *p2PMessageStreamServer) Recv() (*SlyvexdMessage, error) {
	m := new(SlyvexdMessage)
...
func (x *rPCMessageStreamClient) Send(m *SlyvexdMessage) error {
	return x.ClientStream.SendMsg(m)
}

func (x *rPCMessageStreamClient) Recv() (*SlyvexdMessage, error) {
	m := new(SlyvexdMessage)
	if err := x.ClientStream.RecvMsg(m); err != nil {
		return nil, err
	}
...
func (x *rPCMessageStreamServer) Send(m *SlyvexdMessage) error {
	return x.ServerStream.SendMsg(m)
}

func (x *rPCMessageStreamServer) Recv() (*SlyvexdMessage, error) {
	m := new(SlyvexdMessage)
	if err := x.ServerStream.RecvMsg(m); err != nil {
		return nil, err
	}
