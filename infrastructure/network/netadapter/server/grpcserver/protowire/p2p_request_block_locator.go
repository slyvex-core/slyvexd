...
func (x *SlyvexdMessage_RequestBlockLocator) toAppMessage() (appmessage.Message, error) {
	if x == nil {
...
func (x *SlyvexdMessage_RequestBlockLocator) fromAppMessage(msgGetBlockLocator *appmessage.MsgRequestBlockLocator) error {
