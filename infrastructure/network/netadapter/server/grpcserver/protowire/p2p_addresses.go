...
func (x *SlyvexdMessage_Addresses) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SlyvexdMessage_Addresses is nil")
	}
...
func (x *SlyvexdMessage_Addresses) fromAppMessage(msgAddresses *appmessage.MsgAddresses) error {
