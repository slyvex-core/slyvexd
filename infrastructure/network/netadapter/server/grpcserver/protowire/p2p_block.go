...
func (x *SlyvexdMessage_Block) toAppMessage() (appmessage.Message, error) {
	if x == nil {
		return nil, errors.Wrap(errorNil, "SlyvexdMessage_Block is nil")
	}
	return x.Block.toAppMessage()
}

func (x *SlyvexdMessage_Block) fromAppMessage(msgBlock *appmessage.MsgBlock) error {
