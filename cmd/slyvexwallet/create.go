...
import (
	...
	"github.com/slyvex-core/slyvexd/cmd/slyvexwallet/libslyvexwallet/bip32"
...
func create(conf *createConfig) error {
	...
	fmt.Printf("Notice the above is neither a secret key to your wallet " +
		"(use \"slyvexwallet dump-unencrypted-data\" to see a secret seed phrase) " +
		"nor a wallet public address (use \"slyvexwallet new-address\" to create and see one)\n\n")
	...
	if len(signerExtendedPublicKeys) > 0 {
		cosignerIndex, err = libslyvexwallet.MinimumCosignerIndex(signerExtendedPublicKeys, extendedPublicKeys)
		if err != nil {
			return err
		}
	}
